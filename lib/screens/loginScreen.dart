...
import 'package:profiles_app/classes/accountProvider.dart';
                ...
                child: Column(
                  children: [
                    ...
                    CustomTextField(
                        ...
                        isSecured: Provider.of<AccountProvider>(context,listen: true).hidePassword,
                        suffixIcon: IconButton(
                          onPressed: ()=> Provider.of<AccountProvider>(context,listen: false).changePasswordState(),
                          icon: Icon(Provider.of<AccountProvider>(context,listen: true).hidePassword?Icons.visibility_off:Icons.visibility),
                        ),
