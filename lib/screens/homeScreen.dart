                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: Text('${myWeather.name} Information',style: TextStyle(fontSize: 25,color: Colors.black,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                            ),
                            Padding(
                              padding: const EdgeInsets.all(15),
                              child: Row(
                                ...
                                children: [
                                  ...
                                  CustomText(title:'City ID',value: myWeather.id),
                                ],
                              ),
                            ),
                            Padding(
